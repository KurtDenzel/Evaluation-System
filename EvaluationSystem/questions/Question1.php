...
<nav class="navbar navbar-expand-sm bg-dark navbar-dark text-center p-3 justify-content-center" style="padding-left: 25px; padding-right: 25px;"> 
  <ul class="navbar-nav">
...
<div class="container-fluid p-5 px-5 " style="background-color: #9B2E2E">
  <div class="row px-5">
    ...
    <div class="p-4 shadow-4 rounded-3" style="background-color: hsl(0, 0%, 94%); width: 180vh;">
